...
usort($commentaries, fn ($obj1, $obj2) => strcmp(
      $obj1['legal_domain']
        ? str_replace(['Ä', 'Ö', 'Ü'], ['Ae', 'Oe', 'Ue'], strtoupper($obj1['legal_domain']['label']))
        : '',
      $obj2['legal_domain']
        ? str_replace(['Ä', 'Ö', 'Ü'], ['Ae', 'Oe', 'Ue'], strtoupper($obj2['legal_domain']['label']))
        : ''
  )
);
